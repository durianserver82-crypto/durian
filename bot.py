...
# ============= Environment Variable থেকে ডেটা নিন =============
BOT_TOKEN = os.environ.get('BOT_TOKEN')  # Railway-এ সেট করবেন
...
# টোকেন সেট করা আছে কিনা চেক করুন
if not BOT_TOKEN:
    print("❌ BOT_TOKEN সেট করা হয়নি! Railway-এ Environment Variable সেট করুন।")
    exit(1)
...
def handle_text_messages(message):
    ...
    if text == '📱 Get Number' or text == '/getnumber':
        if str(chat_id) not in user_country:
            bot.send_message(chat_id, "❌ আগে দেশ সিলেক্ট করুন!")
            return
